The script 'main.m' implements the Monty Hall problem. The program supports any user-defined integer number of doors. Statistical clarity can be obtained by running 
